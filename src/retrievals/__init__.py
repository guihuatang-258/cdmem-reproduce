...
FEWSHOT_BUILDER = dict(alfworld=dict(reflect=ReflectFewshotBuilder, cdmem=CDMemFewshotBuilder, cdmem_autogen=CDMemFewshotBuilder, autoguide=AutoguideFewshotBuilder, expel=ExpelFewshotBuilder,react=ReflectFewshotBuilder),
